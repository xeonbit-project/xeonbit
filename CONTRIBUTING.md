...
posted to #xeonbit-dev on irc.freenode.net).
...
Copyright (c) 2017-2018 The Xeonbit Project.
...
The "Xeonbit Maintainer Team" is defined in this document as the following users:
- fluffypony
- xeonbitmooo
- hyc
...
- Users SHALL NOT log feature requests, ideas, or suggestions unrelated to Xeonbit code or Xeonbit's dependency code or Xeonbit's potential/future dependency code or research which successfully implements Xeonbit.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the Xeonbit Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the Xeonbit Maintainer Team.
